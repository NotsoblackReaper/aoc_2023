...
int main()
{
	...
	total_time += benchmark_day<std::string, N>(input::data_as_string("Input/day1.txt"), aoc::day1::part_1, aoc::day1::part_2, 1);
	...
	*/
	...
	//total_time += benchmark_day<std::string, N>(input::data_as_string("Input/day12.txt"), aoc::day12::part_1, aoc::day12::part_2, 12);
